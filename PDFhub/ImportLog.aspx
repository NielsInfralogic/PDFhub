<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="ImportLog.aspx.cs" Inherits="PDFhub.ImportLog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            <td style="width:100px;">
                <telerik:RadLabel ID="RadLabel1" runat="server" Text="Plan import log" CssClass="header-text" Width="300" ></telerik:RadLabel>
            </td>
    ...
    <telerik:RadGrid ID="RadGridLog" runat="server" OnNeedDataSource="RadGridLog_NeedDataSource"  OnItemDataBound="RadGridLog_ItemDataBound" OnItemCommand="RadGridLog_ItemCommand"
        ...
        <MasterTableView AllowCustomSorting="false" AllowSorting="false" TableLayout="Auto" CommandItemDisplay="Top" ShowGroupFooter="true">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn UniqueName="FileName" DataField="FileName" HeaderText="FileName" DataType="System.String" FilterControlWidth="280px">
                    <HeaderStyle Width="400px" HorizontalAlign="Left" CssClass="rgRowRightAligned" />
                    <ItemStyle Width="400px" HorizontalAlign="Left" CssClass="rgRowRightAligned" />
                </telerik:GridBoundColumn>
