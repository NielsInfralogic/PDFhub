<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckPages.aspx.cs" Inherits="PDFhub.CheckPages" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="padding: 10px 10px 10px 10px;background-color:ghostwhite;">
            ...
            <table id="Table2" cellspacing="2" cellpadding="1" width="500" border="0" rules="none" style="border-collapse: collapse;">
                ...
                <tr>
                    <td>
                        <asp:Panel ID="PageTablePanel" runat="server" ScrollBars="Vertical" Height="440" BorderWidth="1" BorderStyle="Solid">
                           
                            <telerik:RadListBox ID="RadListBoxPages" runat="server">

                                <ItemTemplate>
                                     <img class="page-image" src='Images/<%# DataBinder.Eval(Container, "Value")%>' />
                                     <span class="page-title"> <%# DataBinder.Eval(Container, "Text")%></span> 
                                </ItemTemplate>
                ...
                <tr>    
                    <td align="center">
                        <telerik:RadButton ID="btnRun" Text="Run check" runat="server"  OnClick="btnRun_Click"></telerik:RadButton>
                        &nbsp;
