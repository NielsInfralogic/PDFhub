<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Release.aspx.cs" Inherits="PDFhub.Release" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="padding: 10px 10px 10px 10px;background-color:ghostwhite;">
            ...
            <table id="Table2" cellspacing="2" cellpadding="1" width="500" border="0" rules="none" style="border-collapse: collapse;">
                ...
                <tr>
                    <td colspan="2">
                        <asp:Panel ID="ChannelTablePanel" runat="server" ScrollBars="Vertical" Height="435" BorderWidth="1" BorderStyle="Solid" > 
                ...
                <tr>    
                    <td colspan="2" align="center">
                        <telerik:RadButton ID="btnUpdate" Text="Release" runat="server"  OnClick="BtnUpdate_Click"></telerik:RadButton>
                        &nbsp;
