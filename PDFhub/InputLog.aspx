<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="InputLog.aspx.cs" Inherits="PDFhub.InputLog"  %>
    ...
    <table  class="jumbotron"  style="width:100%;">
        <tr>
            <td style="width:100px;">
                <telerik:RadLabel ID="RadLabel1" runat="server" Text="File input log" CssClass="header-text" Width="300" ></telerik:RadLabel>
            </td>
    ...
    <telerik:RadGrid ID="RadGridLog" runat="server" OnNeedDataSource="RadGridLog_NeedDataSource"  OnItemDataBound="RadGridLog_ItemDataBound" OnItemCommand="RadGridLog_ItemCommand"
        ...
        <MasterTableView AllowCustomSorting="false" AllowSorting="false" TableLayout="Auto" CommandItemDisplay="Top" ShowGroupFooter="true">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn UniqueName="Source" DataField="Source" HeaderText="Queue" DataType="System.String" AllowFiltering="false">
                    <HeaderStyle Width="160px" HorizontalAlign="Left" CssClass="rgRowRightAligned" />
                    <ItemStyle Width="160px" HorizontalAlign="Left" CssClass="rgRowRightAligned" />
                </telerik:GridBoundColumn>
