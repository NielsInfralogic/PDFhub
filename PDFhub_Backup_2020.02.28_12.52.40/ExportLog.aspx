<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="ExportLog.aspx.cs" Inherits="PDFhub.ExportLog" %>
     ...
     <table  class="jumbotron"  style="width:100%;">
        <tr>
            <td style="width:100px;">
                <telerik:RadLabel ID="RadLabel1" runat="server" Text="Export log" CssClass="header-text" Width="300"  ></telerik:RadLabel>
            </td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <telerik:RadGrid ID="RadGridLog" runat="server" OnNeedDataSource="RadGridLog_NeedDataSource"  OnItemDataBound="RadGridLog_ItemDataBound" OnItemCommand="RadGridLog_ItemCommand" OnPreRender="RadGridLog_PreRender"
        ...
        <MasterTableView AllowCustomSorting="false" AllowSorting="false" TableLayout="Auto" CommandItemDisplay="Top" ShowGroupFooter="true">
            ...
            <CommandItemTemplate>
                <telerik:RadToolBar RenderMode="Lightweight" ID="RadToolBar1" runat="server" AutoPostBack="true"  style="width: 100%;">
                    <Items>
                        ...
                        <telerik:RadToolBarButton Text="Get internal log" CommandName="GetLog" ImageUrl="Images/document.png" OuterCssClass="rightButton">
                        </telerik:RadToolBarButton>
                    </Items>
                </telerik:RadToolBar>
            </CommandItemTemplate>
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn UniqueName="Source" DataField="Source" HeaderText="Export" DataType="System.String" AllowFiltering="false" >
                    <HeaderStyle Width="180px" HorizontalAlign="Left" CssClass="rgRowRightAligned" />
                    <ItemStyle Width="180px" HorizontalAlign="Left" CssClass="rgRowRightAligned" />
                    
                </telerik:GridBoundColumn>

                <telerik:GridBoundColumn UniqueName="FileName" DataField="FileName" HeaderText="FileName" DataType="System.String" FilterControlWidth="220">
                    <HeaderStyle Width="340px" HorizontalAlign="Left" CssClass="rgRowRightAligned" />
                    <ItemStyle Width="340px" HorizontalAlign="Left" CssClass="rgRowRightAligned" />
                </telerik:GridBoundColumn>
