<%@ Page Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="MaintLog.aspx.cs" Inherits="PDFhub.MaintLog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            <td style="width:100px;">
                <telerik:RadLabel ID="RadLabel1" runat="server" Text="Maintenance log" CssClass="header-text" Width="300" ></telerik:RadLabel>
            </td>
